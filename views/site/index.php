                ...
                <form id="addTaskForm" class="row g-3 needs-validation" action="/task/add" method="post" novalidate>
                    <div class="col-md-4">
                        ...
                        <div class="input-group has-validation">
                            <input type="email" name="Task[email]" class="form-control" id="taskEmail" value="" required>
                    ...
                    <div class="col-md-4 ">
                        ...
                        <div class="input-group has-validation">
                            <input type="text" class="form-control" name="Task[username]" id="taskUsername" value="" required>
                            <div class="invalid-feedback">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="input-group has-validation">
                            <textarea type="text" class="form-control" name="Task[text]" id="taskText" aria-describedby="inputGroupPrepend" required></textarea>
                            <div class="invalid-feedback">
